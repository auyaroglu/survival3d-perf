...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function gs(e,t,n){return new Sa({name:`SphericalGaussianBlur`,defines:{SAMPLES:ts,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:ys(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function _s(){return new Sa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ys(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function vs(){return new Sa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ys(),fragmentShader:`
	...
	`}var bs=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ta(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
float band(float v, float steps) {
  return uBands < 0.5 ? v : floor(v * steps + 0.5) / steps;
}

// Moonlight + a warm "torch" around the player. No dynamic lights, no shadow maps.
vec3 shade(vec3 albedo, vec3 n, vec3 wp) {
  albedo = max(mix(vec3(dot(albedo, vec3(0.2126, 0.7152, 0.0722))), albedo, uSaturation), 0.0);
  float ndl = band(max(dot(n, uSunDir), 0.0), uBands);
  vec3 toP = uPlayerPos + vec3(0.0, 1.5, 0.0) - wp;
  float d2 = dot(toP, toP);
  float att = band(1.0 / (1.0 + d2 * 0.035), uBands * 2.0);
  float ndt = band(0.35 + 0.65 * max(dot(n, toP * inversesqrt(d2 + 1e-4)), 0.0), uBands);
  return albedo * (uAmbient + uSunColor * ndl + uTorchColor * att * ndt) * uExposure;
}

// Cheap back-light on silhouettes; uRimColor is black in styles that do not use it.
vec3 rimLight(vec3 n, vec3 wp) {
  float f = 1.0 - max(dot(n, normalize(cameraPosition - wp)), 0.0);
  return uRimColor * f * f * f;
}

vec3 applyFog(vec3 c, float depth) {
  return mix(c, uFogColor, smoothstep(uFogNear, uFogFar, depth));
}
`;function su(){let e=new Fr;return e.setAttribute(`position`,new br(new Float32Array([-.5,-.5,0,.5,-.5,0,.5,.5,0,-.5,.5,0]),3)),e.setIndex([0,1,2,0,2,3]),e}var cu=`
...
`,uu=class{capacity;mesh;start;vel;col;attrs;head=0;dirtyFrom=-1;dirtyTo=-1;wrapped=!1;spawnedThisFrame=0;constructor(e){this.capacity=e,this.start=new Float32Array(e*4),this.vel=new Float32Array(e*4),this.col=new Float32Array(e*4);let t=su(),n=new yo;n.setIndex(t.index),n.setAttribute(`position`,t.getAttribute(`position`)),this.attrs=[this.start,this.vel,this.col].map(e=>{let t=new Hi(e,4);return t.setUsage(Je),t}),n.setAttribute(`iStart`,this.attrs[0]),n.setAttribute(`iVel`,this.attrs[1]),n.setAttribute(`iCol`,this.attrs[2]),n.instanceCount=e,this.mesh=new wi(n,new Sa({uniforms:{uTime:au.uTime},vertexShader:cu,fragmentShader:lu,transparent:!0,depthWrite:!1,blending:2})),this.mesh.frustumCulled=!1,this.mesh.renderOrder=3}spawn(e,t,n,r,i,a,o,s,c,l,u){let d=this.head,f=d*4;this.start[f]=e,this.start[f+1]=t,this.start[f+2]=n,this.start[f+3]=au.uTime.value,this.vel[f]=r,this.vel[f+1]=i,this.vel[f+2]=a,this.vel[f+3]=o,this.col[f]=c,this.col[f+1]=l,this.col[f+2]=u,this.col[f+3]=s,this.dirtyFrom<0&&(this.dirtyFrom=d),this.dirtyTo=d+1,this.head=d+1,this.head>=this.capacity&&(this.head=0,this.wrapped=!0),this.spawnedThisFrame++}burst(e,t,n,r,i,a,o,s,c,l){for(let u=0;u<r;u++){let r=Math.random()*Math.PI*2,u=.4+Math.random()*.9,d=i*(.5+Math.random()*.7);this.spawn(e,t,n,Math.cos(r)*d,u*i,Math.sin(r)*d,a*(.6+Math.random()*.6),o*(.7+Math.random()*.6),s,c,l)}}flush(){if(this.spawnedThisFrame=0,!(this.dirtyFrom<0)){for(let e=0;e<3;e++){let t=this.attrs[e];t.clearUpdateRanges(),this.wrapped||t.addUpdateRange(this.dirtyFrom*4,(this.dirtyTo-this.dirtyFrom)*4),t.needsUpdate=!0}this.dirtyFrom=-1,this.dirtyTo=-1,this.wrapped=!1}}},du=`
...
`,pu=class{capacity;mesh;count=0;pos;col;aPos;aCol;geo=new yo;constructor(e,t,n=1){this.capacity=e,this.pos=new Float32Array(e*4),this.col=new Float32Array(e*4),this.aPos=new Hi(this.pos,4),this.aCol=new Hi(this.col,4),this.aPos.setUsage(Je),this.aCol.setUsage(Je);let r=su();this.geo.setIndex(r.index),this.geo.setAttribute(`position`,r.getAttribute(`position`)),this.geo.setAttribute(`iPos`,this.aPos),this.geo.setAttribute(`iCol`,this.aCol),this.mesh=new wi(this.geo,new Sa({uniforms:{uShape:{value:t===`glow`?0:t===`gem`?1:2}},vertexShader:du,fragmentShader:fu,transparent:!0,depthWrite:!1,blending:n})),this.mesh.frustumCulled=!1,this.mesh.renderOrder=2}begin(){this.count=0}push(e,t,n,r,i,a,o,s){if(this.count>=this.capacity)return;let c=this.count++*4;this.pos[c]=e,this.pos[c+1]=t,this.pos[c+2]=n,this.pos[c+3]=r,this.col[c]=i,this.col[c+1]=a,this.col[c+2]=o,this.col[c+3]=s}end(){let e=this.count;this.geo.instanceCount=e,this.mesh.visible=e>0,e!==0&&(this.aPos.clearUpdateRanges(),this.aPos.addUpdateRange(0,e*4),this.aPos.needsUpdate=!0,this.aCol.clearUpdateRanges(),this.aCol.addUpdateRange(0,e*4),this.aCol.needsUpdate=!0)}},mu=class{mesh;mat;age=1;radius=1;constructor(){let e=new pa(.9,1,48);e.rotateX(-Math.PI/2),this.mat=new fi({color:8377599,transparent:!0,depthWrite:!1,blending:2,fog:!1}),this.mesh=new wi(e,this.mat),this.mesh.visible=!1,this.mesh.renderOrder=2}fire(e,t,n){this.age=0,this.radius=n,this.mesh.position.set(e,.12,t),this.mesh.visible=!0}update(e){if(!this.mesh.visible)return;if(this.age+=e/.35,this.age>=1){this.mesh.visible=!1;return}let t=1-(1-this.age)*(1-this.age);this.mesh.scale.setScalar(Math.max(.01,t*this.radius)),this.mat.opacity=1-this.age}};function hu(e,t=!1){let n=e[0].index!==null,r=new Set(Object.keys(e[0].attributes)),i=new Set(Object.keys(e[0].morphAttributes)),a={},o={},s=e[0].morphTargetsRelative,c=new Fr,l=0;for(let u=0;u<e.length;++u){let d=e[u],f=0;if(n!==(d.index!==null))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them.`),null;for(let e in d.attributes){if(!r.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure "`+e+`" attribute exists among all geometries, or in none of them.`),null;a[e]===void 0&&(a[e]=[]),a[e].push(d.attributes[e]),f++}if(f!==r.size)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. Make sure all geometries have the same number of attributes.`),null;if(s!==d.morphTargetsRelative)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. .morphTargetsRelative must be consistent throughout all geometries.`),null;for(let e in d.morphAttributes){if(!i.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`.  .morphAttributes must be consistent throughout all geometries.`),null;o[e]===void 0&&(o[e]=[]),o[e].push(d.morphAttributes[e])}if(t){let e;if(n)e=d.index.count;else if(d.attributes.position!==void 0)e=d.attributes.position.count;else return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. The geometry must have either an index or a position attribute`),null;c.addGroup(l,e,u),l+=e}}if(n){let t=0,n=[];for(let r=0;r<e.length;++r){let i=e[r].index;for(let e=0;e<i.count;++e)n.push(i.getX(e)+t);t+=e[r].attributes.position.count}c.setIndex(n)}for(let e in a){let t=gu(a[e]);if(!t)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` attribute.`),null;c.setAttribute(e,t)}for(let e in o){let t=o[e][0].length;if(t!==0){c.morphAttributes=c.morphAttributes||{},c.morphAttributes[e]=[];for(let n=0;n<t;++n){let t=[];for(let r=0;r<o[e].length;++r)t.push(o[e][r][n]);let r=gu(t);if(!r)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` morphAttribute.`),null;c.morphAttributes[e].push(r)}}}return c}function gu(e){let t,n,r,i=-1,a=0;for(let o=0;o<e.length;++o){let s=e[o];if(t===void 0&&(t=s.array.constructor),t!==s.array.constructor)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes.`),null;if(n===void 0&&(n=s.itemSize),n!==s.itemSize)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes.`),null;if(r===void 0&&(r=s.normalized),r!==s.normalized)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes.`),null;if(i===-1&&(i=s.gpuType),i!==s.gpuType)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes.`),null;a+=s.count*n}let o=new t(a),s=new br(o,n,r),c=0;for(let t=0;t<e.length;++t){let r=e[t];if(r.isInterleavedBufferAttribute){let e=c/n;for(let t=0,i=r.count;t<i;t++)for(let i=0;i<n;i++){let n=r.getComponent(t,i);s.setComponent(t+e,i,n)}}else o.set(r.array,c);c+=r.count*n}return i!==void 0&&(s.gpuType=i),s}function _u(e,t=1e-4){t=Math.max(t,2**-52);let n={},r=e.getIndex(),i=e.getAttribute(`position`),a=r?r.count:i.count,o=0,s=Object.keys(e.attributes),c={},l={},u=[],d=[`getX`,`getY`,`getZ`,`getW`],f=[`setX`,`setY`,`setZ`,`setW`];for(let t=0,n=s.length;t<n;t++){let n=s[t],r=e.attributes[n];c[n]=new r.constructor(new r.array.constructor(r.count*r.itemSize),r.itemSize,r.normalized);let i=e.morphAttributes[n];i&&(l[n]||(l[n]=[]),i.forEach((e,t)=>{let r=new e.array.constructor(e.count*e.itemSize);l[n][t]=new e.constructor(r,e.itemSize,e.normalized)}))}let p=t*.5,m=10**Math.log10(1/t),h=p*m;for(let t=0;t<a;t++){let i=r?r.getX(t):t,a=``;for(let t=0,n=s.length;t<n;t++){let n=s[t],r=e.getAttribute(n),o=r.itemSize;for(let e=0;e<o;e++)a+=`${Math.trunc(r[d[e]](i)*m+h)},`}if(a in n)u.push(n[a]);else{for(let t=0,n=s.length;t<n;t++){let n=s[t],r=e.getAttribute(n),a=e.morphAttributes[n],u=r.itemSize,p=c[n],m=l[n];for(let e=0;e<u;e++){let t=d[e],n=f[e];if(p[n](o,r[t](i)),a)for(let e=0,r=a.length;e<r;e++)m[e][n](o,a[e][t](i))}}n[a]=o,u.push(o),o++}}let g=e.clone();for(let t in e.attributes){let e=c[t];if(g.setAttribute(t,new e.constructor(e.array.slice(0,o*e.itemSize),e.itemSize,e.normalized)),t in l)for(let e=0;e<l[t].length;e++){let n=l[t][e];g.morphAttributes[t][e]=new n.constructor(n.array.slice(0,o*n.itemSize),n.itemSize,n.normalized)}}return g.setIndex(u),g}var vu=`data:application/octet-stream;base64,`,yu={name:`ghoul`,vertexCount:165,triangles:314,frames:24,rows:25,animSpeed:1.35,shadowSize:1.1,height:1.493,sections:{indices:{offset:0,length:1884},colors:{offset:1884,length:495},vat:{offset:2380,length:33e3}}},bu=new jt,xu=new ln;function Q(e,t,n,r=1,i=1,a=1,o=0,s=0,c=0){return bu.setFromEuler(xu.set(o,s,c)),new J().compose(new G(e,t,n),bu,new G(r,i,a))}function $(e,t,n,r){let i=e.index?e.toNonIndexed():e;r&&i.applyMatrix4(r),i.deleteAttribute(`uv`),i.deleteAttribute(`normal`);let a=i.getAttribute(`position`).count,o=new Y(t),s=new Float32Array(a*3),c=new Float32Array(a);for(let e=0;e<a;e++)s[e*3]=o.r,s[e*3+1]=o.g,s[e*3+2]=o.b,c[e]=n;return i.setAttribute(`color`,new br(s,3)),i.setAttribute(`part`,new br(c,1)),i}function Su(e){return _u(hu(e,!1),1e-4)}function Cu(e,t){let n=new Float32Array(t.length*3);t.forEach((t,r)=>n.set(e[t],r*3));let r=new Fr;return r.setAttribute(`position`,new br(n,3)),r}function wu(e,t,n,r){let i=e.y-t,a=e.z-n,o=Math.cos(r),s=Math.sin(r);e.y=t+i*o-a*s,e.z=n+i*s+a*o}function Tu(e,t,n,r){let i=e.x-t,a=e.y-n,o=Math.cos(r),s=Math.sin(r);e.x=t+i*o-a*s,e.y=n+i*s+a*o}var Eu=Math.PI*2;function Du(){return{name:`slime`,geometry:Su([$(new da(.5,2),5230698,0,Q(0,.36,0,1,.75,1)),$(new da(.075,0),790806,0,Q(.16,.46,.4)),$(new da(.075,0),790806,0,Q(-.16,.46,.4))]),anim:(e,t,n)=>{let r=Math.sin(n*Eu),i=1+.22*r,a=1/Math.sqrt(i);e.x=e.x*a+Math.sin(n*Eu+e.y*6)*.02,e.z*=a,e.y=e.y*i+Math.max(0,r)*.35},frames:16,animSpeed:1.3,shadowSize:1.15,doubleSided:!1}}function Ou(){let e=1.3,t=[[.1,0,.12],[.1,0,-.12],[.45,0,.2],[.42,0,-.17],[.82,0,.04]],n=[0,2,3,0,3,1,2,4,3],r=t.map(([e,t,n])=>[-e,t,n]);return{name:`bat`,geometry:Su([$(new da(.17,1),7031434,0,Q(0,e,0,1,.95,1.3)),$(new la(.05,.14,4),7031434,0,Q(.08,1.48,.12)),$(new la(.05,.14,4),7031434,0,Q(-.08,1.48,.12)),$(Cu(t,n),4008535,1,Q(0,e,0)),$(Cu(r,n),4008535,2,Q(0,e,0))]),anim:(t,n,r)=>{let i=Math.sin(r*Eu)*.95;if(n===1||n===2){let r=n===1?1:-1,a=Math.abs(t.x)-.1;Tu(t,.1*r,e,r*i*(.55+.75*a/.7))}t.y-=Math.sin(r*Eu)*.06},frames:12,animSpeed:3.2,shadowSize:.7,doubleSided:!0}}function ku(){let e=13616808;return{name:`walker`,geometry:Su([$(new ca(.2,.26,.55,8),6057810,0,Q(0,.95,0)),$(new da(.19,1),e,0,Q(0,1.42,0)),$(new da(.045,0),16728112,0,Q(.075,1.45,.16)),$(new da(.045,0),16728112,0,Q(-.075,1.45,.16)),$(new ca(.06,.05,.5,6),e,1,Q(.3,.93,0)),$(new ca(.06,.05,.5,6),e,2,Q(-.3,.93,0)),$(new ca(.08,.06,.66,6),3752527,3,Q(.12,.35,0)),$(new ca(.08,.06,.66,6),3752527,4,Q(-.12,.35,0))]),anim:(e,t,n)=>{let r=Math.sin(n*Eu);t===1?wu(e,1.18,0,-1.15-r*.25):t===2?wu(e,1.18,0,-1.15+r*.25):t===3?wu(e,.68,0,r*.6):t===4?wu(e,.68,0,-r*.6):e.x+=r*.04*(e.y-.7),e.y+=Math.abs(r)*.04},frames:16,animSpeed:1.5,shadowSize:.95,doubleSided:!1}}function Au(e,t,n){let r=new Ri(e,t,n,T,_);return r.minFilter=s,r.magFilter=s,r.generateMipmaps=!1,r.needsUpdate=!0,r}function ju(e,t){let n=atob(t.slice(t.indexOf(`,`)+1)),r=new Uint8Array(n.length);for(let e=0;e<n.length;e++)r[e]=n.charCodeAt(e);let{indices:i,colors:a,vat:o}=e.sections,s=new Uint16Array(r.buffer,o.offset,o.length/2),c=new Uint8Array(r.buffer,a.offset,a.length),l=e.vertexCount,u=new Float32Array(l*3),d=new Float32Array(l*3),f=new Y;for(let e=0;e<l;e++){for(let t=0;t<3;t++)u[e*3+t]=gr.fromHalfFloat(s[e*4+t]);f.setRGB(c[e*3]/255,c[e*3+1]/255,c[e*3+2]/255,He),d[e*3]=f.r,d[e*3+1]=f.g,d[e*3+2]=f.b}let p=new Fr;return p.setIndex(new br(new Uint16Array(r.buffer,i.offset,i.length/2),1)),p.setAttribute(`position`,new br(u,3)),p.setAttribute(`color`,new br(d,3)),{name:e.name,geometry:p,vat:Au(s,l,e.rows),frames:e.frames,animSpeed:e.animSpeed,shadowSize:e.shadowSize,doubleSided:!1}}function Mu(){return[...[Du(),Ou(),ku()].map(e=>({...e,vat:Nu(e)})),ju(yu,vu)]}function Nu(e){let t=e.geometry.getAttribute(`position`),n=e.geometry.getAttribute(`part`),r=t.count,i=e.frames+1,a=new Uint16Array(r*i*4),o=new G;for(let s=0;s<i;s++){let i=s%e.frames/e.frames;for(let c=0;c<r;c++){o.fromBufferAttribute(t,c),e.anim(o,n.getX(c),i);let l=(s*r+c)*4;a[l]=gr.toHalfFloat(o.x),a[l+1]=gr.toHalfFloat(o.y),a[l+2]=gr.toHalfFloat(o.z),a[l+3]=gr.toHalfFloat(1)}}return Au(a,r,i)}var Pu=`
attribute float vid;
attribute vec3 aColor;
attribute vec4 iPosRot; // x, y, z, yaw
attribute vec4 iAnim;   // phase offset, scale, hit flash, tint amount
...
void main() {
  float row = fract(uTime * uAnimSpeed + iAnim.x) * uFrames;
  vec2 uv = vec2((vid + 0.5) / uVatSize.x, (row + 0.5) / uVatSize.y);
  // A hit makes the body swell for an instant: cheap, very readable impact feedback.
  vec3 p = texture2D(uVat, uv).xyz * iAnim.y * (1.0 + iAnim.z * 0.16);
  float c = cos(iPosRot.w);
  float s = sin(iPosRot.w);
  vec3 wp = vec3(c * p.x + s * p.z, p.y, c * p.z - s * p.x) + iPosRot.xyz;
  vec4 mv = viewMatrix * vec4(wp, 1.0);
  vWorldPos = wp;
  vDepth = -mv.z;
  // Tint code: 1 mini-boss, 2 champion, 3 burning, 4 chilled, 5 shocked, 6 weakened.
  float code = iAnim.w;
  float lum = dot(aColor, vec3(0.33)) + 0.25;
  vColor = aColor;
  if (code > 5.5) vColor = mix(aColor, vec3(0.75, 0.35, 1.0) * lum, 0.6);
  else if (code > 4.5) vColor = mix(aColor, vec3(1.0, 1.0, 0.55) * (lum + 0.35), 0.7);
  else if (code > 3.5) vColor = mix(aColor, vec3(0.45, 0.8, 1.0) * lum, 0.7);
  else if (code > 2.5) vColor = mix(aColor, vec3(1.0, 0.42, 0.08) * (lum + 0.2), 0.6);
  else if (code > 1.5) vColor = aColor * vec3(1.9, 1.5, 0.45);
  else if (code > 0.5) vColor = aColor * uTint;
  vFlash = iAnim.z;
  gl_Position = projectionMatrix * mv;
}
`,Fu=`
...
void main() {
  // Faceted normals from screen-space derivatives: no normal attribute, no second VAT texture.
  vec3 n = normalize(cross(dFdx(vWorldPos), dFdy(vWorldPos)));
  vec3 col = shade(vColor, n, vWorldPos) + rimLight(n, vWorldPos);
  col = mix(col, vec3(1.0), vFlash * 0.7);
...
void main() {
  vUv = position.xz;
  float size = uSize * iAnim.y;
  vec4 mv = viewMatrix * vec4(iPosRot.x + position.x * size, 0.03, iPosRot.z + position.z * size, 1.0);
  vDepth = -mv.z;
  gl_Position = projectionMatrix * mv;
}
`,Lu=`
...
void main() {
  float a = smoothstep(0.5, 0.12, length(vUv)) * 0.5 * (1.0 - smoothstep(uFogNear, uFogFar, vDepth));
  gl_FragColor = vec4(0.0, 0.0, 0.0, a);
}
`;function Ru(){let e=new Fr;return e.setAttribute(`position`,new br(new Float32Array([-.5,0,-.5,.5,0,-.5,.5,0,.5,-.5,0,.5]),3)),e.setIndex([0,2,1,0,3,2]),e}var zu=class{capacity;mesh;shadow;triangles;count=0;posRot;animData;aPosRot;aAnim;geo=new yo;shadowGeo=new yo;constructor(e,t){this.capacity=t;let n=e.geometry,r=n.getAttribute(`position`).count;this.triangles=n.index.count/3;let i=new Float32Array(r);for(let e=0;e<r;e++)i[e]=e;this.posRot=new Float32Array(t*4),this.animData=new Float32Array(t*4),this.aPosRot=new Hi(this.posRot,4),this.aAnim=new Hi(this.animData,4),this.aPosRot.setUsage(Je),this.aAnim.setUsage(Je),this.geo.setIndex(n.index),this.geo.setAttribute(`position`,n.getAttribute(`position`)),this.geo.setAttribute(`aColor`,n.getAttribute(`color`)),this.geo.setAttribute(`vid`,new br(i,1)),this.geo.setAttribute(`iPosRot`,this.aPosRot),this.geo.setAttribute(`iAnim`,this.aAnim);let a=e.vat;this.mesh=new wi(this.geo,new Sa({uniforms:{...au,uVat:{value:a},uVatSize:{value:[a.image.width,a.image.height]},uFrames:{value:e.frames},uAnimSpeed:{value:e.animSpeed},uTint:{value:new Y(1.9,.55,.5)}},vertexShader:Pu,fragmentShader:Fu,side:e.doubleSided?2:0})),this.mesh.frustumCulled=!1;let o=Ru();this.shadowGeo.setIndex(o.index),this.shadowGeo.setAttribute(`position`,o.getAttribute(`position`)),this.shadowGeo.setAttribute(`iPosRot`,this.aPosRot),this.shadowGeo.setAttribute(`iAnim`,this.aAnim),this.shadow=new wi(this.shadowGeo,new Sa({uniforms:{uFogNear:au.uFogNear,uFogFar:au.uFogFar,uSize:{value:e.shadowSize}},vertexShader:Iu,fragmentShader:Lu,transparent:!0,depthWrite:!1,side:2})),this.shadow.frustumCulled=!1,this.shadow.renderOrder=1}begin(){this.count=0}push(e,t,n,r,i,a,o){if(this.count>=this.capacity)return;let s=this.count++*4,c=this.posRot,l=this.animData;c[s]=e,c[s+1]=0,c[s+2]=t,c[s+3]=n,l[s]=r,l[s+1]=i,l[s+2]=a,l[s+3]=o}end(e){let t=this.count;if(this.geo.instanceCount=t,this.shadowGeo.instanceCount=t,this.mesh.visible=t>0,this.shadow.visible=e&&t>0,t!==0)for(let e of[this.aPosRot,this.aAnim])e.clearUpdateRanges(),e.addUpdateRange(0,t*4),e.needsUpdate=!0}},Bu=[`hips`,`spine`,`head`,`armL`,`armR`,`legL`,`legR`];function Vu(e,t,n,r,i,a,o,s){let c=new oa(e,t,n).translate(r,i,a),l=c.getAttribute(`position`).count,u=new Y(o),d=new Float32Array(l*3),f=new Uint16Array(l*4),p=new Float32Array(l*4),m=Bu.indexOf(s);for(let e=0;e<l;e++)d.set([u.r,u.g,u.b],e*3),f[e*4]=m,p[e*4]=1;return c.setAttribute(`color`,new br(d,3)),c.setAttribute(`skinIndex`,new xr(f,4)),c.setAttribute(`skinWeight`,new br(p,4)),c}function Hu(){let e=new Ri(new Uint8Array([90,170,255]),3,1,O);return e.minFilter=i,e.magFilter=i,e.needsUpdate=!0,e}function Uu(e){let t=new jt,n=new ln;return e.flatMap(([e,r,i])=>t.setFromEuler(n.set(e,r,i)).toArray())}var Wu=class{mesh;mixer;walk;lambert=new Ta({vertexColors:!0,flatShading:!0});toon=new wa({vertexColors:!0,gradientMap:Hu()});constructor(){let e=hu([Vu(.42,.2,.28,0,.78,0,2765637,`hips`),Vu(.5,.6,.3,0,1.17,0,4153242,`spine`),Vu(.46,.8,.05,0,1,-.19,9051947,`spine`),Vu(.32,.32,.32,0,1.65,0,14267276,`head`),Vu(.36,.12,.36,0,1.83,0,9279400,`head`),Vu(.14,.55,.14,.36,1.05,0,4153242,`armL`),Vu(.14,.55,.14,-.36,1.05,0,4153242,`armR`),Vu(.05,.05,.95,-.36,.8,.5,14217983,`armR`),Vu(.17,.7,.17,.13,.38,0,2765637,`legL`),Vu(.17,.7,.17,-.13,.38,0,2765637,`legR`)]),t=Object.fromEntries(Bu.map(e=>{let t=new Li;return t.name=e,[e,t]}));t.hips.position.set(0,.75,0),t.spine.position.set(0,.1,0),t.head.position.set(0,.62,0),t.armL.position.set(.36,.45,0),t.armR.position.set(-.36,.45,0),t.legL.position.set(.13,0,0),t.legR.position.set(-.13,0,0),t.hips.add(t.spine,t.legL,t.legR),t.spine.add(t.head,t.armL,t.armR),t.hips.updateMatrixWorld(!0),this.mesh=new Ii(e,this.lambert),this.mesh.add(t.hips),this.mesh.bind(new Vi(Bu.map(e=>t[e]))),this.mesh.frustumCulled=!1;let n=[0,.15,.3,.45,.6],r=[.7,0,-.7,0,.7],i=new Xa(`walk`,.6,[new qa(`legL.quaternion`,n,Uu(r.map(e=>[e,0,0]))),new qa(`legR.quaternion`,n,Uu(r.map(e=>[-e,0,0]))),new qa(`armL.quaternion`,n,Uu(r.map(e=>[-e*.7,0,0]))),new qa(`armR.quaternion`,n,Uu(r.map(e=>[-.35+e*.2,0,0]))),new qa(`spine.quaternion`,n,Uu(r.map(e=>[.12,e*.15,0]))),new Ya(`hips.position`,n,[0,.75,0,0,.8,0,0,.75,0,0,.8,0,0,.75,0])]);this.mixer=new zo(this.mesh),this.walk=this.mixer.clipAction(i),this.walk.play()}setHurt(e){this.lambert.emissive.setRGB(e*.9,e*.08,e*.08),this.toon.emissive.setRGB(e*.9,e*.08,e*.08)}setToon(e){this.mesh.material=e?this.toon:this.lambert}update(e,t,n,r,i){this.mesh.position.set(t,0,n),this.mesh.rotation.y=r,this.walk.timeScale=i?1.25:0,this.mixer.update(e)}};function Gu(e){return Math.sin(e*.07)*3+Math.sin(e*.023+1.3)*4}function Ku(e){return Math.sin(e*.06+2)*3+Math.sin(e*.027+.4)*4}function qu(e,t){let n=Gu(t);return Math.round((e-n)/36)*36+n}function Ju(e,t){let n=Ku(e);return Math.round((t-n)/36)*36+n}function Yu(e,t){return Math.min(Math.abs(e-qu(e,t)),Math.abs(t-Ju(e,t)))}var Xu=9,Zu=4,Qu=5,$u=18,ed=2.5,td=[.78,.4,.8,.42,.6,.24,.6,.62];function nd(e,t,n){let r=Math.imul(e|0,374761393)^Math.imul(t|0,668265263)^Math.imul(n,1274126177);return r=Math.imul(r^r>>>13,1274126177),((r^r>>>16)>>>0)/4294967296}var rd=[.36,.56,.72];function id(e,t,n=rd){let r=nd(Math.floor(e/3),Math.floor(t/3),99);return r<n[0]?0:r<n[1]?1:r<n[2]?2:3}var ad=class e{static MAX=567;count=0;version=0;x=new Float32Array(e.MAX);z=new Float32Array(e.MAX);radius=new Float32Array(e.MAX);scale=new Float32Array(e.MAX);yaw=new Float32Array(e.MAX);kind=new Uint8Array(e.MAX);cellStart=new Uint16Array(82);centerX=1e9;centerZ=1e9;zones=rd;n=0;clearX=0;clearZ=0;clearR=0;add(e,t,n,r,i){if(t*t+n*n<36||(t-this.clearX)**2+(n-this.clearZ)**2<this.clearR*this.clearR)return;let a=this.n++;this.x[a]=t,this.z[a]=n,this.kind[a]=e,this.scale[a]=r,this.radius[a]=td[e]*r,this.yaw[a]=i}update(e,t){let n=Math.floor(e/9),r=Math.floor(t/9);if(n!==this.centerX||r!==this.centerZ){this.centerX=n,this.centerZ=r,this.n=0;for(let e=0;e<Xu;e++)for(let t=0;t<Xu;t++)this.cellStart[e*Xu+t]=this.n,this.fillCell(n-Zu+t,r-Zu+e);this.cellStart[81]=this.n,this.count=this.n,this.version++}}fillCell(e,t){let n=e*9,r=t*9,i=id(e,t,this.zones),a=Math.ceil(r/$u)*$u;if(a<r+9){let e=qu(n+9/2,a);e>=n&&e<n+9&&this.add(5,e+(a/$u%2==0?ed:-2.5),a,1,0)}let o=Math.ceil(n/$u)*$u;if(o<n+9){let e=Ju(o,r+9/2);e>=r&&e<r+9&&this.add(5,o,e+(o/$u%2==0?ed:-2.5),1,0)}let s=i===0?3.6:i===1?5.4:i===2?3.2:1.1,c=Math.min(Qu,Math.floor(nd(e,t,1)*s));for(let a=0;a<c;a++){let o,s,c,l=nd(e,t,50+a)*Math.PI*2,u=nd(e,t,30+a);if(i===1&&u<.8){let i=(Math.floor(nd(e,t,60)*16)+a*5)%16;o=n+(i%4+.5)*(9/4)+(nd(e,t,70+a)-.5)*.3,s=r+(Math.floor(i/4)+.5)*(9/4)+(nd(e,t,80+a)-.5)*.3,c=3,l=(nd(e,t,50+a)-.5)*.3}else if(i===2&&u<.7){let i=(Math.floor(nd(e,t,60)*9)+a*4)%9;o=n+(i%3+.5)*3,s=r+(Math.floor(i/3)+.5)*3;let u=nd(e,t,90+a);c=u<.4?4:u<.75?6:7,l=Math.floor(nd(e,t,50+a)*4)*(Math.PI/2)}else o=n+(.12+nd(e,t,10+a)*.76)*9,s=r+(.12+nd(e,t,20+a)*.76)*9,c=i===0?u<.75?0:u<.9?2:1:i===1?1:i===2||u<.5?2:0;if(Yu(o,s)<2.7+td[c])continue;let d=c===2?.7+nd(e,t,40+a)*.9:c===4||c===6||c===7?.9+nd(e,t,40+a)*.25:.8+nd(e,t,40+a)*.4;this.add(c,o,s,d,l)}}exclude(e,t,n){this.clearX=e,this.clearZ=t,this.clearR=n,this.centerX=1e9}resolve(e,t,n,r){let i=Math.floor(e/9)-this.centerX+Zu,a=Math.floor(t/9)-this.centerZ+Zu,o=!1;for(let r=-1;r<=1;r++){let s=a+r;if(!(s<0||s>=Xu))for(let r=-1;r<=1;r++){let a=i+r;if(a<0||a>=Xu)continue;let c=s*Xu+a;for(let r=this.cellStart[c],i=this.cellStart[c+1];r<i;r++){let i=e-this.x[r],a=t-this.z[r],s=n+this.radius[r],c=i*i+a*a;if(c>=s*s)continue;let l=Math.sqrt(c)||.001,u=s-l;e+=i/l*u-a/l*u*.35,t+=a/l*u+i/l*u*.35,o=!0}}}return r.x=e,r.z=t,o}};function od(e=256){let n=e=>{let t=new Float32Array(e*e);for(let e=0;e<t.length;e++)t[e]=Math.random();return(n,r)=>{let i=n*e,a=r*e,o=Math.floor(i),s=Math.floor(a),c=i-o,l=a-s,u=c*c*(3-2*c),d=l*l*(3-2*l),f=(n,r)=>t[r%e*e+n%e],p=f(o,s)+(f(o+1,s)-f(o,s))*u;return p+(f(o,s+1)+(f(o+1,s+1)-f(o,s+1))*u-p)*d}},r=n(8),i=n(32),a=n(128),o=new Uint8Array(e*e*4);for(let t=0;t<e;t++)for(let n=0;n<e;n++){let s=n/e,c=t/e,l=(t*e+n)*4;o[l]=(r(s,c)*.65+i(s,c)*.35)*255,o[l+1]=(i(s,c)*.4+a(s,c)*.6)*255,o[l+3]=255}let c=new Ri(o,e,e,T,u);return c.wrapS=t,c.wrapT=t,c.magFilter=s,c.minFilter=l,c.generateMipmaps=!0,c.needsUpdate=!0,c}var sd=`
varying vec3 vWorldPos;
varying float vDepth;
...
// Same road network as src/sim/roads.ts (keep in sync): two families of winding paths, 36 m apart.
float roadDistance(vec2 p) {
  float wa = sin(p.y * 0.07) * 3.0 + sin(p.y * 0.023 + 1.3) * 4.0;
  float wb = sin(p.x * 0.06 + 2.0) * 3.0 + sin(p.x * 0.027 + 0.4) * 4.0;
  float u = p.x - wa;
  float v = p.y - wb;
  return min(abs(u - 36.0 * floor(u / 36.0 + 0.5)), abs(v - 36.0 * floor(v / 36.0 + 0.5)));
}
...
void main() {
  ...
  float d = roadDistance(p) + (n2 - 0.5) * 1.1;
  ...
  vec3 col = applyFog(shade(albedo, vec3(0.0, 1.0, 0.0), vWorldPos), vDepth);
  gl_FragColor = vec4(col, 1.0);
  #include <colorspace_fragment>
}
`,ld=class{group=new Dn;props=new Dn;ground;lambert=new Ta({vertexColors:!0,flatShading:!0});toon=new wa({vertexColors:!0,gradientMap:Hu()});solids=[];clutter=[];solidVersion=-1;zones=rd;lanterns=[];lightPools=null;constructor(e=!0){let t=new fa(260,260);t.rotateX(-Math.PI/2),this.ground=new wi(t,new Sa({uniforms:{...au,uNoise:{value:od()},uColA:{value:new Y(2902586)},uColB:{value:new Y(4868662)},uColC:{value:new Y(1451039)},uRoad:{value:new Y(8021320)}},vertexShader:sd,fragmentShader:cd})),this.ground.frustumCulled=!1,this.group.add(this.ground,this.props);let n=Su([$(new ca(.1,.2,1.6,5),3812388,0,Q(0,.8,0)),$(new la(1.05,1.5,6),2051914,0,Q(0,1.9,0)),$(new la(.8,1.3,6),2646104,0,Q(0,2.7,0)),$(new la(.5,1.1,6),3371110,0,Q(0,3.45,0))]),r=Su([$(new da(.7,0),5857390,0,Q(0,.25,0,1.2,.7,1))]),i=e=>{let t=e.toNonIndexed();return t.computeVertexNormals(),t};if(e){this.props.add(this.scatter(i(n),140,.55,.95),this.scatter(i(r),90,.5,1.4));return}let a=Su([$(new ca(.09,.24,2.6,5),3024418,0,Q(0,1.3,0)),$(new ca(.03,.08,1.3,4),3024418,0,Q(.42,2,0,1,1,1,0,0,-.9)),$(new ca(.03,.07,1.1,4),3024418,0,Q(-.36,2.3,.1,1,1,1,.2,0,.8)),$(new ca(.02,.06,.9,4),3024418,0,Q(.05,2.75,-.3,1,1,1,-.8,0,.1))]),o=Su([$(new oa(.62,.78,.16),7305868,0,Q(0,.39,0)),$(new ca(.31,.31,.16,8,1,!1,0,Math.PI),7305868,0,Q(0,.78,0,1,1,1,Math.PI/2,0,Math.PI/2)),$(new oa(.8,.12,.32),4870754,0,Q(0,.06,0))]),s=Su([$(new oa(1.25,.2,1.25),8354932,0,Q(0,.1,0)),$(new oa(1,.2,1),9867914,0,Q(0,.3,0)),$(new ca(.4,.46,2,10),11578268,0,Q(0,1.4,0)),$(new oa(1.05,.16,1.05),9867914,0,Q(0,2.48,0)),$(new oa(1.3,.26,1.3),9078654,0,Q(0,2.69,0)),$(new oa(1.5,.3,.7),8354932,0,Q(0,2.97,0))]),c=Su([$(new ca(.05,.07,1.9,5),1841696,0,Q(0,.95,0)),$(new oa(.3,.06,.3),1841696,0,Q(0,1.95,0)),$(new oa(.22,.3,.22),16767370,0,Q(0,2.15,0)),$(new la(.24,.2,4),1841696,0,Q(0,2.4,0,1,1,1,0,Math.PI/4,0))]),l=Su([$(new oa(1.25,.2,1.25),8354932,0,Q(0,.1,0)),$(new oa(1,.2,1),9867914,0,Q(0,.3,0)),$(new ca(.42,.46,1.15,10),11578268,0,Q(0,.97,0)),$(new oa(.34,.62,.3),10591374,0,Q(-.2,1.8,.14,1,1,1,0,.5,.1)),$(new oa(.3,.3,.36),9867914,0,Q(.2,1.66,-.12,1,1,1,.15,.2,-.2)),$(new oa(.2,.18,.22),10986131,0,Q(.12,1.62,.24,1,1,1,0,.9,.3)),$(new ca(.4,.41,.95,10),10986131,0,Q(1.15,.41,.35,1,1,1,Math.PI/2,.6,0)),$(new oa(1.05,.22,1.05),9078654,0,Q(.95,.13,-.95,1,1,1,0,.4,.06))]),u=Su([$(new oa(1.25,.2,1.25),8354932,0,Q(0,.1,0)),$(new oa(1,.2,1),9867914,0,Q(0,.3,0)),$(new ca(.44,.46,.5,10),11578268,0,Q(0,.65,0)),$(new oa(.3,.34,.3),10591374,0,Q(-.18,1.02,.12,1,1,1,.1,.6,-.15)),$(new oa(.24,.16,.3),9867914,0,Q(.2,.95,-.1,1,1,1,0,.3,.25)),$(new da(.3,0),9867914,0,Q(.95,.16,.5,1.2,.7,1)),$(new da(.22,0),10986131,0,Q(-.85,.12,-.7,1,.7,1.3))]);for(let e of[n,a,r,o,s,c,l,u]){let t=new Xi(i(e),this.lambert,420);t.count=0,t.frustumCulled=!1,this.solids.push(t),this.props.add(t)}if(this.solids.length!==8)throw Error(`obstacle meshes out of sync with OB_* kinds`);let d=new fa(1,1);d.rotateX(-Math.PI/2);let f=document.createElement(`canvas`);f.width=f.height=128;let p=f.getContext(`2d`),m=p.createRadialGradient(64,64,0,64,64,64);m.addColorStop(0,`rgba(255, 200, 110, 0.85)`),m.addColorStop(.35,`rgba(255, 170, 70, 0.4)`),m.addColorStop(1,`rgba(255, 150, 50, 0)`),p.fillStyle=m,p.fillRect(0,0,128,128),this.lightPools=new Xi(d,new fi({map:new na(f),transparent:!0,depthWrite:!1,blending:2,fog:!0}),96),this.lightPools.count=0,this.lightPools.frustumCulled=!1,this.lightPools.renderOrder=1,this.group.add(this.lightPools);let h=Su([$(new la(.09,.5,3),4160086,0,Q(0,.25,0)),$(new la(.07,.38,3),4885086,0,Q(.13,.19,.05,1,1,1,0,0,-.35)),$(new la(.07,.34,3),3502160,0,Q(-.1,.17,-.08,1,1,1,.3,0,.3))]),g=Su([$(new da(.16,0),8225424,0,Q(0,.07,0,1.3,.6,1)),$(new da(.09,0),9409696,0,Q(.24,.04,.1,1,.6,1.2))]);for(let e of[h,g]){let t=new Xi(i(e),this.lambert,900);t.count=0,t.frustumCulled=!1,this.clutter.push(t),this.props.add(t)}}showObstacles(e,t,n){if(this.solids.length===0||e.version===this.solidVersion)return;this.solidVersion=e.version;let r=new J,i=new jt,a=new G(0,1,0),o=new G,s=new G,c=Array(this.solids.length).fill(0);this.lanterns.length=0;for(let t=0;t<e.count;t++){let n=e.kind[t],l=e.scale[t];i.setFromAxisAngle(a,e.yaw[t]),this.solids[n].setMatrixAt(c[n]++,r.compose(o.set(e.x[t],0,e.z[t]),i,s.set(l,n===0?l*1.15:l,l))),n===5&&(this.lanterns.push(e.x[t],2.15*l,e.z[t]),this.lightPools&&this.lanterns.length/3<=96&&this.lightPools.setMatrixAt(this.lanterns.length/3-1,r.compose(o.set(e.x[t],.05,e.z[t]),i.identity(),s.set(9,1,9))))}this.lightPools&&(this.lightPools.count=Math.min(96,this.lanterns.length/3),this.lightPools.instanceMatrix.needsUpdate=!0),this.solids.forEach((e,t)=>{e.count=c[t],e.instanceMatrix.needsUpdate=!0});let l=Math.floor(t/9),u=Math.floor(n/9),d=[0,0];for(let e=-4;e<=4;e++)for(let t=-4;t<=4;t++){let n=l+t,c=u+e,f=id(n,c,this.zones);for(let e=0;e<9;e++){let t=nd(n,c,200+e)<(f===0||f===3?.8:.3)?0:1;if(d[t]>=900)continue;let l=.7+nd(n,c,230+e)*.9;i.setFromAxisAngle(a,nd(n,c,240+e)*6.28),r.compose(o.set((n+nd(n,c,210+e))*9,0,(c+nd(n,c,220+e))*9),i,s.set(l,l,l)),this.clutter[t].setMatrixAt(d[t]++,r)}}this.clutter.forEach((e,t)=>{e.count=d[t],e.instanceMatrix.needsUpdate=!0})}setToon(e){for(let t of this.props.children)t.material=e?this.toon:this.lambert}setLanternColor(e){(this.lightPools?.material)?.color.setHex(e)}setRealm(e,t,n){this.setGroundColors(e),this.ground.material.uniforms.uRoad.value.setHex(t),this.zones=n,this.solidVersion=-1}setGroundColors(e){let t=this.ground.material.uniforms;t.uColA.value.setHex(e[0]),t.uColB.value.setHex(e[1]),t.uColC.value.setHex(e[2])}scatter(e,t,n,r){let i=new Xi(e,this.lambert,t),a=new J,o=new jt,s=new G(0,1,0);for(let e=0;e<t;e++){let t=0,c=0;do t=(Math.random()-.5)*120,c=(Math.random()-.5)*120;while(t*t+c*c<25);let l=n+Math.random()*(r-n);o.setFromAxisAngle(s,Math.random()*Math.PI*2),i.setMatrixAt(e,a.compose(new G(t,0,c),o,new G(l,l,l)))}return i.instanceMatrix.needsUpdate=!0,i.frustumCulled=!1,i}follow(e,t){this.ground.position.set(Math.round(e/8)*8,0,Math.round(t/8)*8)}},ud=56,dd=class{surface;x=0;z=0;lastActive=-1/0;keys=new Set;pointerId=-1;originX=0;originY=0;joyX=0;joyZ=0;base=document.getElementById(`joy-base`);knob=document.getElementById(`joy-knob`);dashQueued=!1;ultQueued=!1;hold(e){try{this.surface.setPointerCapture(e)}catch{}}consumeUlt(){let e=this.ultQueued;return this.ultQueued=!1,e}consumeDash(){let e=this.dashQueued;return this.dashQueued=!1,e}constructor(e){this.surface=e,window.addEventListener(`keydown`,e=>{this.keys.add(e.code),(e.code===`Space`||e.code===`ShiftLeft`||e.code===`ShiftRight`)&&!e.repeat&&(this.dashQueued=!0,e.preventDefault()),(e.code===`KeyQ`||e.code===`KeyE`||e.code===`KeyF`)&&!e.repeat&&(this.ultQueued=!0)}),window.addEventListener(`keyup`,e=>this.keys.delete(e.code)),window.addEventListener(`blur`,()=>this.keys.clear()),e.addEventListener(`pointerdown`,e=>{this.pointerId===-1&&(this.pointerId=e.pointerId,this.hold(e.pointerId),this.originX=e.clientX,this.originY=e.clientY,this.place(this.base,e.clientX,e.clientY),this.place(this.knob,e.clientX,e.clientY),this.base.style.display=this.knob.style.display=`block`)}),e.addEventListener(`pointermove`,e=>{if(e.pointerId!==this.pointerId)return;let t=e.clientX-this.originX,n=e.clientY-this.originY,r=Math.hypot(t,n);r>ud&&(t*=ud/r,n*=ud/r),this.joyX=t/ud,this.joyZ=n/ud,this.place(this.knob,this.originX+t,this.originY+n)});let t=e=>{e.pointerId===this.pointerId&&(this.pointerId=-1,this.joyX=this.joyZ=0,this.base.style.display=this.knob.style.display=`none`)};e.addEventListener(`pointerup`,t),e.addEventListener(`pointercancel`,t),e.addEventListener(`contextmenu`,e=>e.preventDefault())}place(e,t,n){e.style.left=`${t}px`,e.style.top=`${n}px`}update(e){let t=this.keys,n=(t.has(`KeyD`)||t.has(`ArrowRight`)?1:0)-(t.has(`KeyA`)||t.has(`ArrowLeft`)?1:0),r=(t.has(`KeyS`)||t.has(`ArrowDown`)?1:0)-(t.has(`KeyW`)||t.has(`ArrowUp`)?1:0);n===0&&r===0&&(n=this.joyX,r=this.joyZ),this.x=n,this.z=r,(n!==0||r!==0||this.pointerId!==-1)&&(this.lastActive=e)}},fd=`
...
`,md=class{target;scene=new In;camera=new go;material;size=new W;constructor(){this.target=new Xt(4,4,{depthTexture:new ra(4,4),minFilter:i,magFilter:i}),this.target.texture.colorSpace=He,this.material=new Sa({uniforms:{tColor:{value:this.target.texture},tDepth:{value:this.target.depthTexture},uTexel:{value:new W},uNear:{value:1},uFar:{value:100},uFogNear:au.uFogNear,uFogFar:au.uFogFar,uInk:{value:new Y(329228)}},vertexShader:pd,fragmentShader:fd,depthTest:!1,depthWrite:!1});let e=new Fr;e.setAttribute(`position`,new br(new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),3));let t=new wi(e,this.material);t.frustumCulled=!1,this.scene.add(t)}render(e,t,n,r){e.getDrawingBufferSize(this.size),(this.target.width!==this.size.x||this.target.height!==this.size.y)&&this.target.setSize(this.size.x,this.size.y);let i=this.material.uniforms;i.uTexel.value.set(r/this.size.x,r/this.size.y),i.uNear.value=n.near,i.uFar.value=n.far,e.setRenderTarget(this.target),e.render(t,n),e.setRenderTarget(null),e.render(this.scene,this.camera)}},hd=[{id:`gotik`,label:`gotik`,fog:659480,fogNear:.9,fogFar:2.2,sun:9414911,sunIntensity:1.02,ambient:1845056,ambientIntensity:1.55,torch:16754784,torchIntensity:0,rim:0,rimIntensity:0,bands:0,saturation:1,exposure:1,ground:[2902586,4868662,1451039],hemiSky:3820664,hemiGround:658448,hemiIntensity:1.1,dirIntensity:1.3,pointIntensity:0,toon:!1,outline:!1},{id:`canli`,label:`canlı`,fog:1776186,fogNear:1.1,fogFar:2.7,sun:16758912,sunIntensity:1.14,ambient:3030146,ambientIntensity:1.55,torch:16762992,torchIntensity:0,rim:6277375,rimIntensity:.8,bands:0,saturation:1.2,exposure:1.05,ground:[3106384,6052410,2047290],hemiSky:5925056,hemiGround:2103864,hemiIntensity:1.3,dirIntensity:1.7,pointIntensity:0,toon:!1,outline:!1},{id:`toon`,label:`toon`,fog:1450556,fogNear:1.1,fogFar:2.7,sun:16773324,sunIntensity:1.02,ambient:3951738,ambientIntensity:1.55,torch:16760944,torchIntensity:0,rim:0,rimIntensity:0,bands:3,saturation:1.12,exposure:1.05,ground:[3830864,7104576,2707008],hemiSky:6846640,hemiGround:2239040,hemiIntensity:1.4,dirIntensity:1.6,pointIntensity:0,toon:!0,outline:!0}];export{eo as A,po as B,Ri as C,Fn as D,Je as E,At as F,pa as G,ho as H,J as I,Sa as J,He as K,wi as L,yo as M,Xi as N,Dn as O,s as P,G as Q,fi as R,ca as S,vo as T,jt as U,fa as V,T as W,Gr as X,ai as Y,W as Z,br as _,od as a,sa as b,zu as c,uu as d,mu as f,oa as g,iu as h,ld as i,Hi as j,_ as k,Mu as l,au as m,md as n,ad as o,ou as p,In as q,dd as r,Wu as s,hd as t,pu as u,Fr as v,gr as w,Y as x,na as y,Ta as z};